...
public class TestAndroid {
    ...
    public void testAndroid(final Integer i) throws IOException{
        ...
        Assumptions.assumeTrue(doesNotThrow(() -> getField(classes, "sun.net.www.protocol.https.HttpsURLConnectionImpl", "delegate")), Workflow.warningSupplier("Failed to use HttpURLConnection on Android " + i));
    }
