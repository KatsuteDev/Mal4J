...
abstract class MyAnimeListSchema_Forum extends MyAnimeListSchema {
    ...
    static PollOption asPollOption(final MyAnimeList mal, final Json.JsonObject schema, final Poll poll){
    ...
    static ForumSubBoard asForumSubBoard(final MyAnimeList mal, final Json.JsonObject schema, final ForumBoard forumBoard){
