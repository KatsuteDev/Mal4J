...
abstract class MyAnimeListSchema_Anime extends MyAnimeListSchema {
    ...
    static AnimeStatistics asAnimeStatistics(final MyAnimeList mal, final Json.JsonObject schema){
    ...
    static Broadcast asBroadcast(final MyAnimeList mal, final Json.JsonObject schema){
    ...
    static StartSeason asStartSeason(final MyAnimeList mal, final Json.JsonObject schema){
    ...
    static Studio asStudio(final MyAnimeList mal, final Json.JsonObject schema){
        return new Studio() {
    ...
    static OpeningTheme asOpeningTheme(final MyAnimeList mal, final Json.JsonObject schema, Anime anime){
    ...
    static EndingTheme asEndingTheme(final MyAnimeList mal, final Json.JsonObject schema, Anime anime){
    ...
    static AnimeListStatus asAnimeListStatus(final MyAnimeList mal, final Json.JsonObject schema, final long anime_id){
        return asAnimeListStatus(mal, schema, anime_id, null);
    }

    static AnimeListStatus asAnimeListStatus(final MyAnimeList mal, final Json.JsonObject schema, final AnimePreview anime_preview){
        return asAnimeListStatus(mal, schema, null, Objects.requireNonNull(anime_preview, "Anime preview must not be null"));
    }

    @SuppressWarnings("SpellCheckingInspection")
    private static AnimeListStatus asAnimeListStatus(final MyAnimeList mal, final Json.JsonObject schema, final Long anime_id, final AnimePreview anime_preview) {
    ...
    static AnimePreview asAnimePreview(final MyAnimeList mal, final Json.JsonObject schema){
