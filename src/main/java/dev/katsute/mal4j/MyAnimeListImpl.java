...
// provider
    ...
    public final MangaSearchQuery getManga(){
        return new MangaSearchQuery() {
            ...
            public final List<MangaPreview> search(){
                ...
                for(final JsonObject iterator : response.getJsonArray("data"))
                    manga.add(MyAnimeListSchema_Manga.asMangaPreview(MyAnimeListImpl.this, iterator.getJsonObject("node")));
                return manga;
            }
            ...
            public final PaginatedIterator<MangaPreview> searchAll(){
                return new PagedIterator<>(
                    ...
                    iterator -> MyAnimeListSchema_Manga.asMangaPreview(MyAnimeListImpl.this, iterator.getJsonObject("node"))
                );
            }
    ...
    public final Manga getManga(final long id, final String... fields){
        return MyAnimeListSchema_Manga.asManga(this,
                                               handleResponse(
            () -> service.getManga(
                isTokenAuth ? token : null,
                !isTokenAuth ? client_id : null,
        ...
        return new MangaRankingQuery(Objects.requireNonNull(rankingType, "Ranking type cannot be null")) {
            ...
            public final PaginatedIterator<MangaRanking> searchAll(){
                return new PagedIterator<>(
                    ...
                    iterator -> MyAnimeListSchema_Manga.asMangaRanking(MyAnimeListImpl.this, iterator)
                );
            }
    ...
    public final MangaListUpdate updateMangaListing(final long id){
        return new MangaListUpdate(id) {
            ...
            public synchronized final MangaListStatus update(){
                ...
                return MyAnimeListSchema_Manga.asMangaListStatus(MyAnimeListImpl.this, response, id);
            }
    ...
    public final UserMangaListQuery getUserMangaListing(final String username){
        return new UserMangaListQuery(Objects.requireNonNull(username, "Username cannot be null")) {
            ...
            public final List<MangaListStatus> search(){
                ...
                for(final JsonObject iterator : response.getJsonArray("data"))
                    manga.add(asMangaListStatus(MyAnimeListImpl.this, iterator.getJsonObject("list_status"), MyAnimeListSchema_Manga.asMangaPreview(MyAnimeListImpl.this, iterator.getJsonObject("node"))));
                return manga;
            }
            ...
            public final PaginatedIterator<MangaListStatus> searchAll(){
                return new PagedIterator<>(
                    ...
                    iterator -> asMangaListStatus(MyAnimeListImpl.this, iterator.getJsonObject("list_status"), MyAnimeListSchema_Manga.asMangaPreview(MyAnimeListImpl.this, iterator.getJsonObject("node")))
                );
            }
...
// handle response
    ...
    private static void handleVoidResponse(final ExceptionSupplier<APIStruct.Response<?>,IOException> supplier){
        handleResponseCodes(supplier);
    }

    private static JsonObject handleResponse(final ExceptionSupplier<APIStruct.Response<?>,IOException> supplier){
        final APIStruct.Response<?> response = handleResponseCodes(supplier);
        return response.code() == HttpURLConnection.HTTP_OK ? (JsonObject) response.body() : null;
    }

    private static APIStruct.Response<?> handleResponseCodes(final ExceptionSupplier<APIStruct.Response<?>,IOException> supplier){
        try{
            final APIStruct.Response<?> response = supplier.get();
...
// iterator
    ...
    private static class PagedIterator<T> extends PaginatedIterator<T> {
        ...
        private final Function<Integer, APIStruct.Response<JsonObject>> fullPageSupplier;
        ...
        PagedIterator(
            ...
            final Function<Integer, APIStruct.Response<JsonObject>> fullPageSupplier,
