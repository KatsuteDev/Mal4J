...
public interface MediaItem<MediaType extends Enum<?>,Status extends Enum<?>,ListStatus extends dev.katsute.mal4j.property.ListStatus<?>> extends ID {
     ...
     * This method should only be used if the type value is missing from {@link AnimeType} or {@link MangaType}.
     *
     ...
     * This method should only be used if the status is missing from {@link AnimeAirStatus} or {@link MangaPublishStatus}.
     *
     * @return raw status
     *
     * @see #getStatus()
