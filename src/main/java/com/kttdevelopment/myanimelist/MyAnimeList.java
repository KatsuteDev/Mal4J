...
// forum
    ...
    public abstract List<ForumBoard> getForumBoards();

    // https://myanimelist.net/apiconfig/references/api/v2#operation/forum_topic_get
    public abstract List<ForumBoard> getForumBoards(final int topic_id);

    public abstract List<ForumBoard> getForumBoards(final int topic_id, final int limit);

    public abstract List<ForumBoard> getForumBoards(final int topic_id, final int limit, final int offset);
...
// manga
    ...
    public abstract List<Manga> getManga(final String search, final MangaRanking ranking);

    public abstract List<Manga> getManga(final String search, final MangaRanking ranking, final int limit);

    public abstract List<Manga> getManga(final String search, final MangaRanking ranking, final int limit, final int offset);
