...
import com.kttdevelopment.myanimelist.forum.ForumBoard;
import com.kttdevelopment.myanimelist.manga.*;
import com.kttdevelopment.myanimelist.net.HttpRequestMethod;
...
final class MyAnimeListImpl extends MyAnimeList {
    ...
    @Override
    public final List<ForumBoard> getForumBoards(){
        return null;
    }

    @Override
    public final List<ForumBoard> getForumBoards(final int topic_id){
        return null;
    }

    @Override
    public final List<ForumBoard> getForumBoards(final int topic_id, final int limit){
        return getForumBoards(topic_id, limit, 0);
    }

    @Override
    public final List<ForumBoard> getForumBoards(final int topic_id, final int limit, final int offset){
        return null; // todo
    }
    ...
    @Override
    public final List<Manga> getManga(final String search, final MangaRanking ranking){
        return getManga(search, ranking, 100, 0);
    }

    @Override
    public final List<Manga> getManga(final String search, final MangaRanking ranking, final int limit){
        return getManga(search, ranking, limit, 0);
    }

    @Override
    public final List<Manga> getManga(final String search, final MangaRanking ranking, final int limit, final int offset){
        return null; // todo
    }
